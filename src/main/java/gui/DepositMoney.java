...
public class DepositMoney extends JFrame {
    ...
    private JPanel pnlDepositMoney;
    ...
    public DepositMoney(ArrayList<CustomerDTO> customerDTOArrayList, int i) {
        ...
        if (Files.exists(path)) {
            ...
            btnSend.addActionListener(e -> {
                if (Integer.parseInt(txtMoney.getText()) % 2 != 0) {
                    txtError.setText("Sadece 10 ve 10'un katlarını yatırabilirsiniz" +
                            "Paranız: " + customerDTOArrayList.get(i).getIntCustomerBalance() + "TL");
                } else {
                    int totalMoney = Integer.parseInt(txtMoney.getText()) + customerDTOArrayList.get(i).getIntCustomerBalance();
    ...
    private void initComponents() {
        ...
        getContentPane().add(pnlDepositMoney);
        setVisible(true);
        pack();
    }
}
